 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.janah.me/", wsdlLocation = "http://127.0.0.1:9191/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://ws.janah.me/", "BanqueWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:9191/?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.janah.me/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.janah.me/", "BanqueServicePort"), BanqueService.class, features);
    }
